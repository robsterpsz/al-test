...
const paths = {
  source: path.join(__dirname, '../web_client'),
  javascript: path.join(__dirname, '../web_client/js'),
  images: path.join(__dirname, '../web_client/assets/img'),
  svg: path.join(__dirname, '../web_client/assets/svg'),
